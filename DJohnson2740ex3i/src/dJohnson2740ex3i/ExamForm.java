...
public class ExamForm extends JFrame {
	...
	public ExamForm() {
		...
		questNumList.setBounds(10, 50, 23, 175);
		...
		responsesList.setBounds(56, 48, 33, 175);
		contentPane.add(responsesList);
		
		JLabel lblResults = new JLabel("Results:");
		lblResults.setBounds(171, 11, 79, 14);
		contentPane.add(lblResults);
		
		resultLabel = new JLabel("");
		resultLabel.setBounds(171, 36, 125, 29);
		...
		calcPassButton.setBounds(171, 88, 113, 23);
		...
		calcCorrectButton.setBounds(171, 122, 113, 23);
		...
		calcIncorrectButton.setBounds(171, 156, 113, 23);
		...
		listIncorrectButton.setBounds(171, 190, 113, 23);
		contentPane.add(listIncorrectButton);
		
		questNumLabel = new JLabel("#0:");
		questNumLabel.setBounds(10, 237, 33, 14);
		...
		inputAnswerTextField.setBounds(56, 234, 33, 20);
		...
		prevButton.setBounds(117, 233, 89, 23);
		...
		nextButton.setBounds(117, 267, 89, 23);
	...
	protected void do_listIncorrectButton_actionPerformed(ActionEvent e) {
		...
		if (invalid >= 0) {
			...
			int [] missed;
			StringBuilder result = new StringBuilder("Incorrect: ");
			missed = exam.questionsMissed();
			int i = 0;
			while ( i < missed.length && missed[i] != 0) {
				result.append(missed[i]);
				result.append(" ");
				i++;
			}
